    ...
    datasets: [
      {
        data: [],
        label: 'Job Views',
        borderColor: 'rgba(13, 22, 62, 1)',
        backgroundColor: 'rgba(13, 22, 62, 1)',
        hoverBackgroundColor: 'rgba(13, 22, 62,0.8)',
        pointBackgroundColor: 'rgba(13, 22, 62, 1)',
        pointBorderColor: '#fff',
        pointHoverBackgroundColor: '#fff',
        pointHoverBorderColor: 'rgba(13, 22, 62, 1)',
      },
      {
        data: [],
        label: 'Job Applicant',
        borderColor: 'rgba(22, 102, 186, 1)',
        backgroundColor: 'rgba(22, 102, 186, 1)',
        hoverBackgroundColor: 'rgba(22, 102, 186, 0.8)',
        pointBackgroundColor: 'rgba(22, 102, 186, 1)',
        pointBorderColor: '#fff',
        pointHoverBackgroundColor: '#fff',
        pointHoverBorderColor: 'rgba(22, 102, 186, 0.8)',
      },
    ],
    labels: [ ]
  };

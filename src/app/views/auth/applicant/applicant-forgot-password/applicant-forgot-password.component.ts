...
@Component({
  selector: 'app-applicant-forgot-password',
  animations: [mainAnimations],
  templateUrl: './applicant-forgot-password.component.html',
  styleUrls: ['./applicant-forgot-password.component.scss']
})
export class ApplicantForgotPasswordComponent implements OnInit {

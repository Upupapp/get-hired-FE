...
// SEO-V4: purpose-built 1200×630 OG image (better than logo.png for social previews).
// Generated by tools/generate-og-image.js — dark navy gradient with GetHired branding.
...
export class SeoService {
  ...
  setPageMeta(config: PageMetaConfig): void {
    ...
    if (ogImage) {
      ...
      // SEO-V4: explicit image dimensions help social crawlers (Facebook, LinkedIn,
      // Slack) render the preview without fetching the image first.
      // Values match gethired-og-default.png (1200×630); job-specific images would
      // need overrides if we ever use dynamic images.

...
@Component({
  selector: 'app-job-post-details-answer-question',
  templateUrl: './job-post-details-answer-question.component.html',
  styleUrls: ['./job-post-details-answer-question.component.scss']
})
export class JobPostDetailsAnswerQuestionComponent implements OnInit {

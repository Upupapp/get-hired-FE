...
@Component({
  selector: 'app-invite-applicant-modal',
  animations: [mainAnimations],
  templateUrl: './invite-applicant-modal.component.html',
  styleUrls: ['./invite-applicant-modal.component.scss']
})
export class InviteApplicantModalComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<InviteApplicantModalComponent>,
